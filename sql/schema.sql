...
CREATE TABLE IF NOT EXISTS entrevista (
    ...
    CONSTRAINT chk_nota_candidato CHECK (nota_candidato IS NULL OR nota_candidato BETWEEN 0 AND 10)
);
...
CREATE TABLE IF NOT EXISTS local_entrevista (
    ...
    link VARCHAR(255),
    CONSTRAINT chk_local_entrevista_preenchido CHECK (endereco_fisico IS NOT NULL OR link IS NOT NULL)    
);
...
ALTER TABLE entrevista
    ...
    FOREIGN KEY (id_modalidade) REFERENCES modalidade_entrevista(id_modalidade);

ALTER TABLE entrevista
    ADD CONSTRAINT fk_entrevista_status
    FOREIGN KEY (id_status_entrevista) REFERENCES status_entrevista(id_status);

ALTER TABLE entrevista
    ADD CONSTRAINT fk_entrevista_resultado
    FOREIGN KEY (id_resultado) REFERENCES resultado_entrevista(id_resultado);
...
ALTER TABLE vaga
    ...
    FOREIGN KEY (id_cargo) REFERENCES cargo_vaga(id_cargo);
...
('11111111000101', 'Tech Solutions LTDA', 'Av. Paulista, 1000 - São Paulo/SP'),
('22222222000102', 'Digital Corp LTDA', 'Av. Faria Lima, 1500 - São Paulo/SP'),
('33333333000103', 'FinBank S.A.', 'Av. Rio Branco, 1200 - Rio de Janeiro/RJ'),
('44444444000104', 'Health Plus LTDA', 'Rua dos Hospitais, 300 - Recife/PE'),
('55555555000105', 'Retail Group LTDA', 'Av. das Américas, 2000 - Rio de Janeiro/RJ');
...
INSERT INTO requisito (id_vaga, descricao) VALUES
...
(5, 'Conhecimento básico em lógica de programação'),
...
INSERT INTO vaga (descricao, data_publicacao, quantidade, salario, id_cargo, status, cnpj) VALUES
('Vaga para Desenvolvedor Front-end Júnior', '2026-02-15', 2, 3500.00, 1, TRUE, '11111111000101'),
('Vaga para Desenvolvedor Back-end Sênior', '2026-02-20', 1, 12000.00, 2, TRUE, '22222222000102'),
('Vaga para Product Manager Pleno', '2026-03-01', 1, 9000.00, 3, TRUE, '33333333000103'),
('Vaga para Analista de QA Pleno', '2026-03-05', 2, 6500.00, 4, TRUE, '44444444000104'),
('Vaga para Estagiário de Desenvolvimento', '2026-03-10', 3, 1800.00, 5, TRUE, '11111111000101'),
('Vaga para UX/UI Designer Pleno', '2026-03-12', 1, 7000.00, 6, TRUE, '55555555000105'),
('Vaga para Engenheiro DevOps Sênior', '2026-03-18', 1, 11000.00, 7, TRUE, '22222222000102'),
('Vaga para Analista de Dados Pleno', '2026-04-01', 2, 7500.00, 8, TRUE, '33333333000103'),
('Vaga para Scrum Master Sênior', '2026-04-05', 1, 9500.00, 9, TRUE, '55555555000105'),
('Vaga para Tech Lead Especialista', '2026-04-10', 1, 14000.00, 10, TRUE, '11111111000101');
